#
# Be sure to run `pod lib lint DTZFloatingActionButton.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
 Floating button for your ios app in swift. Used some ideas KCFloatingActionButto
                       DESC

  s.homepage         = 'https://github.com/hintoz/DTZFloatingActionButton'
  ...
  # s.resource_bundles = {
  #   'DTZFloatingActionButton' => ['DTZFloatingActionButton/Assets/*.png']
  # }
